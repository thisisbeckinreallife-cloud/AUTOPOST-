...
export interface HealthReport {
  ...
  checks: {
    ...
    storage: HealthCheck;
    redis: HealthCheck;
    meta_credentials: HealthCheck;
  };
}

export function checkEncryptionKey(): HealthCheck {
...
export async function checkMetaConfig(): Promise<HealthCheck> {
  try {
...
export function checkStorage(): HealthCheck {
...
export function checkRedis(): HealthCheck {
...
export async function getHealthReport(): Promise<HealthReport> {
  ...
  return {
    ok: allOk,
    checks: { encryption_key: encKey, database: db, storage, redis, meta_credentials: meta },
  };
}
